...
export default function Sidebar({
  ...
  const totalReviews = runningTrackers.reduce(
    (acc, t) => acc + (t.prsReviewed || 0),
    0,
  );
    ...
    <aside className={`dashboard-sidebar ${sidebarOpen ? "open" : ""}`}>
      ...
      <div className="sidebar-profile">
        {avatarSrc ? (
          ...
          <div className="sidebar-avatar-initials">{getInitials()}</div>
        )}
      ...
      <div className="sidebar-menu">
        {hasGithubToken && (
          <button
            ...
            className="sidebar-menu-btn unlink-btn"
            title="Unlink GitHub"
          >
            <Link2Off size={20} />
        ...
        <button
          onClick={toggleTheme}
          className="sidebar-menu-btn theme-btn"
          title="Toggle Theme"
        >
        ...
        <button
          ...
          className="sidebar-menu-btn logout-btn"
          title="Sign Out"
        >
          <LogOut size={20} />
          <span>Sign Out</span>
      ...
      <div className="sidebar-footer">
        ...
        <p className="footer-quote">Automating the grind so you can build</p>

        <div className="footer-socials">
          <a
            href="https://github.com/DhryXpert"
            target="_blank"
