// Legacy Google Auth code backup.
// This is archived here for reference because we removed the Google login button.
...
2. Provider login handler inside Login.jsx and SignUp.jsx:
----------------------------------------------------------
...
3. Social login divider & Google login button UI markup in JSX:
---------------------------------------------------------------
